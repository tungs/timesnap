...
*  <a name="js-api-config" href="#js-api-config">#</a> `config` &lt;[Object][]&gt;
    ...
    * <a name="js-config-stop-function-name" href="#js-config-stop-function-name">#</a> `stopFunctionName` &lt;[string][]&gt; *function name* that the client web page can call to stop capturing. For instance, `stopFunctionName: 'stopCapture'` could be called in the client, via `stopCapture()`.
